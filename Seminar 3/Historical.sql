...
GROUP BY l.lesson_id, s.student_id, sol.lesson_id, gl.lesson_id, e.lesson_id, e.ensemble_genre, sol.type_of_instrument, gl.type_of_instrument, ps.price, p.first_name, p.last_name, ph.phone_number
